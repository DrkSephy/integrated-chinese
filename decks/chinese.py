...
deck = {
    ...
    'cards': [
        ...
        #Chapter 7 
        #page 178-179
        {'character': u'说话  ', 'chapter': 7, 'id': 1,    'pinyin': u'shuōhuà',              'type': 'prep',     'translation': 'to; for'},
        {'character': u'说   ', 'chapter': 7, 'id': '1-alt',    'pinyin': u'huà',       'type': 'verb plus object',       'translation': 'to make a phone call'},
        {'character': u'上个 ', 'chapter': 7, 'id': 2,   'pinyin': u'shàng ge',           'type': 'noun',        'translation': 'telephone     '},
        {'character': u'得  ', 'chapter': 7, 'id': 3,    'pinyin': u'de',           'type': 'interjection',    'translation': '(on telephone) Hello!; Hey!'},
        {'character': u'复习  ', 'chapter': 7, 'id': 4,    'pinyin': u'fùxí',              'type': 'verb',        'translation': 'to be present; to be at (a place)'},
        {'character': u'写  ', 'chapter': 7, 'id': 5,    'pinyin': u'xiĕ',              'type': 'adverb',     'translation': 'precisely; exactly'},
        {'character': u'字  ', 'chapter': 7, 'id': 6,    'pinyin': u'zì',              'type': 'pronoun',      'translation': 'you(honorific)'},
        {'character': u'慢  ', 'chapter': 7, 'id':  7,   'pinyin': u'màn',           'type': 'question pronoun',      'translation': 'which'},
        {'character': u'枝  ', 'chapter': 7, 'id': 8,    'pinyin': u'zhī',              'type': 'measure word',        'translation': '(polite measure word for people)'},
        {'character': u'笔 ', 'chapter': 7, 'id': 9,    'pinyin': u'bĭ',             'type': 'time word',        'translation': 'afternoon '},
        {'character': u'张 ', 'chapter': 7, 'id': 10,    'pinyin': u'zhāng',           'type': 'noun',        'translation': 'time  '},
        {'character': u'纸 ', 'chapter': 7, 'id': 11,   'pinyin': u'zhǐ',             'type': 'noun',        'translation': 'question; problem'},
        {'character': u'教  ', 'chapter': 7, 'id': 12,     'pinyin': u'jiāo',               'type': 'modal verb',      'translation': 'will, be going to; to want to, to have a desire to'},
        {'character': u'怎么 ', 'chapter': 7, 'id': 13,    'pinyin': u'zěn me',           'type': 'verb plus object',     'translation':  'to have a meeting '},
        {'character': u'懂  ', 'chapter': 7, 'id': 14,     'pinyin': u'dǒng',               'type': 'verb',       'translation': 'to open; to hold (a meeting, party, etc.)'},
        {'character': u'真  ', 'chapter': 7, 'id': 15,     'pinyin': u'zhēn',               'type': 'noun',       'translation': 'meeting'},
        {'character': u'哪里 ', 'chapter': 7, 'id': 16,    'pinyin': u'năli',            'type': 'time word',       'translation': 'morning          '},
        {'character': u'预习  ', 'chapter': 7, 'id': 17,   'pinyin': u'yùxí',               'type': 'measure word',      'translation': '(measure word for class periods)'},
        {'character': u'学  ', 'chapter': 7, 'id': 18,    'pinyin': u'xué',                'type': 'noun',      'translation': 'class; course; lesson'},
        {'character': u'第 ', 'chapter': 7, 'id': 19,   'pinyin': u'dì',             'type': 'noun',      'translation': 'grade in school'},
        {'character': u'语法 ', 'chapter': 7, 'id': 20,   'pinyin': u'yŭfă',            'type': 'verb plus object/noun',       'translation': 'to give or take a test; test '},
        {'character': u'容易  ', 'chapter': 7, 'id': 21,    'pinyin': u'róngyì',                'type': 'verb',      'translation': 'to give or take a test'},
        {'character': u'生词  ', 'chapter': 7, 'id': 22,    'pinyin': u'shēngcí',                'type': 'noun/verb',      'translation': 'test; to try; to experiment'},
        {'character': u'多 ', 'chapter': 7, 'id': 23,   'pinyin': u'duō',              'type': 'time word',     'translation': 'after; from now on, later on '},
        {'character': u'汉字  ', 'chapter': 7, 'id': 24,     'pinyin': u'Hànzì',            'type': 'noun',      'translation': 'free time'},
        {'character': u'难 ', 'chapter': 7, 'id': 25,    'pinyin': u'nán',             'type': 'conjunction',   'translation': 'if '},
