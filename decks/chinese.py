...
deck = {
    ...
    'cards': [
        ...
        #Chapter 8 
        #page 203-204
        {'character': u'篇  ', 'chapter': 8, 'id': 1,    'pinyin': u'piān',      'type': 'measure word', 'translation':'(measure word for essays, articles, etc.)'},
        {'character': u'日记',  'chapter': 8, 'id': 2,    'pinyin': u'rìjì',       'type': 'noun',          'translation': 'diary'},
        {'character': u'累 ',  'chapter': 8, 'id': 3,   'pinyin': u'lèi ',       'type': 'adjective',    'translation': 'tired     '},
        {'character': u'起床 ', 'chapter': 8, 'id': 4,    'pinyin': u'qĭ chuáng ',         'type': 'verb object',   'translation': 'to get up'},
        {'character': u'床  ',  'chapter': 8, 'id':'4-alt',    'pinyin': u'chuáng ',    'type': 'noun',         'translation': 'bed'},
        {'character': u'洗澡 ', 'chapter': 8, 'id': 5,    'pinyin': u'xĭ zăo',        'type': 'verb object',   'translation': 'to take a bath/shower'},
        {'character': u'早饭 ', 'chapter': 8, 'id': 6,    'pinyin': u'zǎo fàn',         'type': 'noun',          'translation': 'breakfast'},
        {'character': u'一边 ', 'chapter': 8, 'id':  7,   'pinyin': u'yìbiān',        'type': 'adverb',        'translation': 'simultaneously; at the same time'},
        {'character': u'教室 ', 'chapter': 8, 'id': 8,    'pinyin': u'jiàoshì',        'type': 'noun',          'translation': 'classroom'},
        {'character': u'发音 ', 'chapter': 8, 'id': 9,    'pinyin': u'fāyīn',          'type': 'noun',          'translation': 'pronounciation '},
        {'character': u'新 ',   'chapter': 8, 'id': 10,    'pinyin': u'xīn',        'type': 'adjective',     'translation': 'new  '},
        {'character': u'电脑 ', 'chapter': 8, 'id': 11,   'pinyin': u'diànnăo',          'type': 'noun',         'translation': 'computer'},
        {'character': u'脑  ',  'chapter': 8, 'id': '11-alt',     'pinyin': u'năo', 'type': 'noun',          'translation': 'brain'},
        {'character': u'中午 ', 'chapter': 8, 'id': 12,    'pinyin': u'zhōngwŭ',      'type': 'noun',         'translation':  'noon '},
        {'character': u'餐厅  ', 'chapter': 8, 'id': 13,     'pinyin': u'cāntīng',      'type': 'noun',         'translation': 'dining room, cafeteria'},
        {'character': u'午饭  ', 'chapter': 8, 'id': 14,     'pinyin': u'wŭfàn',      'type': 'noun',  'translation': 'lunch, midday meal'},
        {'character': u'上网 ',  'chapter': 8, 'id': 15,    'pinyin': u'shàng wăng',        'type': 'verb object',         'translation': 'to go online; to surf the internet      '},
        {'character': u'宿舍  ', 'chapter': 8, 'id': 16,   'pinyin': u'sùshè',        'type': 'noun',      'translation': 'dormitory'},
        {'character': u'那儿  ', 'chapter': 8, 'id': 17,    'pinyin': u'năr',        'type': 'pronoun',       'translation': 'there'},
        {'character': u'正在 ',  'chapter': 8, 'id': 18,   'pinyin': u'zhèngzài',           'type': 'adverb',    'translation': 'in the middle of (doing something)'},
        {'character': u'以前 ',  'chapter': 8, 'id': 19,   'pinyin': u'yĭqián',         'type': 'time word',         'translation': 'before '},
        {'character': u'告诉  ', 'chapter': 8, 'id': 20,    'pinyin': u'gàosu',     'type': 'verb',    'translation': 'to tell'},
        {'character': u'已经  ', 'chapter': 8, 'id': 21,    'pinyin': u'yǐjīng',    'type': 'adverb',         'translation': 'already'},
        {'character': u'知道  ', 'chapter': 8, 'id': 22,    'pinyin': u'zhīdao',         'type': 'verb',    'translation': 'to know'},

        #Chapter 8 
        #page 217
        {'character': u'封  ', 'chapter': 8, 'id': 1,    'pinyin': u'fēng',              'type': 'measure word',     'translation': '(measure word for letters)'},
        {'character': u'信   ', 'chapter': 8, 'id': 2,    'pinyin': u'xìn',       'type': 'noun',       'translation': 'letter (correspondence)'},
        {'character': u'最近 ', 'chapter': 8, 'id': 3,     'pinyin': u'zuìjìn',           'type': 'time word',        'translation': 'recently     '},
        {'character': u'最  ', 'chapter': 8, 'id': '3-alt1',    'pinyin': u'zuì',           'type': 'adjective',    'translation': '(of superlative degree; most, -est)'},
        {'character': u'近  ', 'chapter': 8, 'id': '3-alt2',    'pinyin': u'jìn',              'type': 'adjective',        'translation': 'close; near'},
        {'character': u'学期  ', 'chapter': 8, 'id': 4,    'pinyin': u'xuéqī',               'type': 'noun',     'translation': 'school term; semester/quarter'},
        {'character': u'除了。。。以外  ', 'chapter': 8, 'id': 5,    'pinyin': u'chúle... yĭwài',              'type': 'conjunction',      'translation': 'in addition to; besides'},
        {'character': u'专业  ', 'chapter': 8, 'id':  6,   'pinyin': u'zhuānyè',           'type': 'noun',      'translation': 'major in college (specialty) '},
        {'character': u'会  ', 'chapter': 8, 'id': 7,    'pinyin': u'huì',              'type': 'av',        'translation': 'can; know how to'},
        {'character': u'后来 ', 'chapter': 8, 'id': 8,    'pinyin': u'hòulái',             'type': 'time word',        'translation': 'later '},
        {'character': u'音乐会', 'chapter': 8, 'id': 9,    'pinyin': u'yīnyuèhuì',           'type': 'noun',        'translation': 'concert  '},
        {'character': u'希望 ', 'chapter': 8, 'id': 10,   'pinyin': u'xīwàng',             'type': 'verb/noun',        'translation': 'to hope; hope'},
        {'character': u'能  ', 'chapter': 8, 'id': 11,     'pinyin': u'néng',               'type': 'av',      'translation': 'can; to be able to'},
        {'character': u'用 ', 'chapter': 8, 'id': 12,    'pinyin': u'yòng',           'type': 'verb',     'translation':  'to use'},
        {'character': u'笑  ', 'chapter': 8, 'id': 13,    'pinyin': u'xiào',                'type': 'verb',      'translation': 'to laugh at; to laugh; to smile'},
        {'character': u'祝  ', 'chapter': 8, 'id': 14,    'pinyin': u'zhù',              'type': 'verb',     'translation': 'to wish (well)'},
    ]
}